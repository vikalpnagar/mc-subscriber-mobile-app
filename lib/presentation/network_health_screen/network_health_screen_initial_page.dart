...
class NetworkHealthScreenInitialPage extends StatelessWidget {
  ...
  Widget _buildTabSection(BuildContext context) {
    return Consumer<NetworkHealthProvider>(builder: (context, provider, child) {
      return Container(
          width: double.infinity,
          ...
          decoration: BoxDecoration(
              border: Border(
                  bottom:
                      BorderSide(color: appTheme.blue_gray_700, width: 1.h))),
          child: Row(children: [
            GestureDetector(
                onTap: () {
                  provider
                ...
                child: Container(
                    ...
                    child: Text('Overview',
                        style: TextStyleHelper.instance.body14BoldInter
                            .copyWith(color: appTheme.indigo_200)))),
            SizedBox(width: 32.h),
            GestureDetector(
                onTap: () {
                  provider
        ...
        child: Container(
            ...
            child:
              ...
              Container(
                  ...
                  child: Text('Network Health',
                      style: TextStyleHelper.instance.title22BoldInter)),
              SizedBox(height: 12.h),
              Expanded(child: Consumer<NetworkHealthProvider>(
                  builder: (context, provider, child) {
                return ListView.builder(
                    itemCount: provider.healthStatusList
                        .length, // Modified: Removed null check and cast
                    itemBuilder: (context, index) {
                      return HealthStatusItemWidget(
                          healthStatusItemModel: provider.healthStatusList[
                              index]); // Modified: Removed null check and cast
                    });
              })),
            ])));
  }
